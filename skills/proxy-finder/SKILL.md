...
license: MIT
description: >
  免费代理机场搜集与节点测试技能。搜索可用机场订阅源、下载订阅、测试节点连通性、
  筛选可用节点并写入 mihomo 配置。当用户需要找免费节点、测试代理可用性、配置代理订阅时触发。
  触发词：找节点、搜机场、免费代理、测试节点、代理订阅、proxy finder。
allowed-tools:
  - terminal
  - read_file
  - write_file
...
metadata:
  hermes:
    tags: [proxy, v2ray, clash, network, automation, scraping]
    category: devops
